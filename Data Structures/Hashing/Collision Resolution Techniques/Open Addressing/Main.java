...
public class Main{
    public static void main(String [] args){
        ...
        System.out.println("This is a program to implement basic functionalities of linear probing resolution techniques...");
        System.out.print("Enter the size of the array : ");
        int size = sc.nextInt();

        // quadraticProbing dc = new quadraticProbing(size);
        doubleHashing dc = new doubleHashing(size);
